...
```{r PlotMap2, echo = FALSE, message=FALSE, warning=FALSE,fig.width=16, fig.height=12}
# Change Name variable from Factor to character type
siteLocations$Sub.Region <- as.factor(siteLocations$Sub.Region)

# Setting your own colors manually:
pal <- colorFactor(
  palette = c("blue", "red", "green"),#, 'green', "yellow", "orange", "black", "purple", "pink", "brown", "grey"),
  domain = siteLocations$Sub.Region
)
